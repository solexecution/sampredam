...
window.CONFIG = {
  ...
  gallery: [
    ...
    { src: "images/gallery/livinga.jpg", alt: "Living Room" },
  ...
  heroImages: [
    ...
    "images/gallery/hall_staircase1.jpg",
  ],
  floorPlans: [
