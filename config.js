...
window.CONFIG = {
  ...
  gallery: [
    ...
    { src: "images/hero/balmore_walk_2.jpg", alt: "Front Exterior — View 2" },
    { src: "images/hero/back_garden.png", alt: "Rear Garden" },
    { src: "images/gallery/bugs_bottom_1.jpg", alt: "Bugs Bottom — View 1" },
    { src: "images/gallery/bugs_bottom_2.jpg", alt: "Bugs Bottom — View 2" },
    { src: "images/hero/hall_staircase.jpg", alt: "Entrance Hall & Staircase" },
  ...
  heroImages: [
    ...
    "images/hero/back_garden.png",
    "images/hero/hall_staircase.jpg",
  ],
  floorPlans: [
