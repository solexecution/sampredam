...
window.CONFIG = {
  ...
  rooms: [
    { name: "Hallway", lengthM: "", widthM: "", description: "Home entrance full of natural light." },
    { name: "Living Room", lengthM: "", widthM: "", description: "Spacious reception room with a characterful multi-fuel stove." },
    {
      name: "Kitchen/Diner",
      lengthM: "",
      widthM: "",
    ...
    { name: "Primary Bedroom", lengthM: "", widthM: "", description: "South-facing master bedroom with view on the street." },
    {
      name: "Bedroom 2",
      lengthM: "",
      widthM: "",
    ...
    { name: "Bedroom 3", lengthM: "", widthM: "", description: "South-facing third bedroom, ideal as a child's room or home office." },
    { name: "Bathroom", lengthM: "", widthM: "", description: "Family bathroom with bathtub." },
    { name: "Patio", lengthM: "", widthM: "", description: "Generous paved sun terrace — ideal for BBQs and summer evenings." },
    {
    ...
    { name: "Front Garden", lengthM: "", widthM: "", description: "Landscaped front garden with paved south-facing seating area." },
  ],
  gallery: [
